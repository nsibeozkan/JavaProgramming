...
public class UnaryOperators {
    ...
    public static void main(String[] args) {
        ...
        int c =100;
        System.out.println(c++);//post increment:first passes the current value then increases by 1 right away
        ...
        int x = 200;
        System.out.println(--x);// pre decrement: increases the value by 1 right away

        int y = 200;
        System.out.println(y--);//post decrement:first passes the current value then increases by 1 right away
